export default {
  ...
  otherTypes: 'image/jpg,image/png,image/jpeg,application/x-shockwave-flash,application/octet-stream,audio/x-mpeg,audio/mpeg3,flv-application/octet-stream'
}
