...
var POBrowser = {
    isChromeAndGreaterThan42: function () {
        ...
        // $.post("http://192.168.12.58/poserver.zz", {
            Info: "PageOfficeLink",
            pageurl: strURL,
            options: strOptions,
            params: strArgument
...
var ZDFAPP = {
    openWindow: function (strURL, strOptions) {
        ...
        // $.post( "http://192.168.12.58/poserver.zz", {Info: "ZDFAPPLink", pageurl: strURL}, function (data) {
            location.href = data
        })
    }
};
...
// POBrowser.addCssByLink(POBrowser.getRootPath() + "/static/js/pobstyle.css");
POBrowser.checkSSL();
