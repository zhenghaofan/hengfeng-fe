<template lang="html">
  <div class="preview-box">
    ...
    <!-- <div class="g-tc g-mt20" v-show="(type == 5 && !multiExers) || (type != 5)"> -->
      <!-- <a href="#" class="btn btn-green" @click.prevent="previewFile">返回</a>
...
export default {
  ...
  watch: {
    resource(val) {
      ...
      this.resourceDictName = GL_CONST.RESOURCETYPESOBJ[val.resourceDictId];
      ...
      if (val.textbook) {
        ...
        this.termDictName = GL_CONST.TERMOBJ[val.textbook.termDictId];
      }

      //题型类别 习题才有
      if (val.childDictId) {
        this.childDitTemplate = val.template;
        this.childDictName = GL_CONST.EXESTYPESOBJ[this.childDitTemplate];
      }
