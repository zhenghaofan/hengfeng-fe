...
(function () {
    ...
    window.UMEDITOR_CONFIG = {
        ...
        // ,imageUrl:"http://192.168.12.58/manage/file/upload"             //图片上传提交地址
        // ,imagePath:"http://192.168.12.58/upload"                    //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        // ,imageFieldName: "file"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        // ,imagePathFormat:'http://192.168.12.58/upload'
