  ...
  <div class="tree">
      ...
      <div v-for="(first, fIndex) in list" :key="first.id">
        ...
        <h2 class="tit-h2">
          ...
          <span v-show="first.isEditName">
            <el-input v-model="first.newEditName" class="elInput" placeholder="（空）" clearable></el-input>
        ...
        <div v-if="first.isAddNode">
          <el-input v-model="first.newNodeName" class="elInput" placeholder="（空）" clearable style=""></el-input>
        ...
        <div v-if="first.isAddChildNode">
          <el-input v-model="first.newChildNodeName" class="elInput" placeholder="（空）" clearable style="padding-left:25px;"></el-input>
          ...
          <div class="con-h2" v-if="first.children.length > 0" v-for="(sec, sIndex) in first.children" :key="sec.id">
            ...
            <h3 class="tit-h3">
              ...
              <span v-show="sec.isEditName">
                <el-input v-model="sec.newEditName" class="elInput" placeholder="（空）" clearable style=""></el-input>
            ...
            <div v-if="sec.isAddNode">
              <el-input v-model="sec.newNodeName" class="elInput" placeholder="（空）" clearable style=""></el-input>
            ...
            <div v-if="sec.isAddChildNode">
              <el-input v-model="sec.newChildNodeName" class="elInput" placeholder="（空）" clearable style="padding-left:25px;"></el-input>
              ...
              <div class="con-h2" v-if="sec.children.length > 0" v-for="(thr, tIndex) in sec.children" :key="thr.id">
                ...
                <h4 class="tit-h4">
                  ...
                  <span v-show="thr.isEditName">
                    <el-input v-model="thr.newEditName" class="elInput" placeholder="（空）" clearable style=""></el-input>
                ...
                <div v-if="thr.isAddNode">
                  <el-input v-model="thr.newNodeName" class="elInput" placeholder="（空）" clearable style=""></el-input>
                ...
                <div v-if="thr.isAddChildNode">
                  <el-input v-model="thr.newChildNodeName" class="elInput" placeholder="（空）" clearable style="padding-left:25px;"></el-input>
                  ...
                  <div class="con-h2" v-if="thr.children.length > 0" v-for="(four, fourIndex) in thr.children" :key="four.id">
                    ...
                    <h4 class="tit-h4">
                      ...
                      <span v-show="four.isEditName">
                        <el-input v-model="four.newEditName" class="elInput" placeholder="（空）" clearable style=""></el-input>
                    ...
                    <div v-if="four.isAddNode">
                      <el-input v-model="four.newNodeName" class="elInput" placeholder="（空）" clearable style=""></el-input>
                    ...
                    <div v-if="four.isAddChildNode">
                      <el-input v-model="four.newChildNodeName" class="elInput" placeholder="（空）" clearable style="padding-left:25px;"></el-input>
                      ...
                      <div class="con-h2" v-if="four.children.length > 0" v-for="(fif, fifIndex) in four.children" :key="fif.id">
                        ...
                        <h4 class="tit-h4">
                          ...
                          <span v-show="fif.isEditName">
                            <el-input v-model="fif.newEditName" class="elInput" placeholder="（空）" clearable style=""></el-input>
                        ...
                        <div v-if="fif.isAddNode">
                          <el-input v-model="fif.newNodeName" class="elInput" placeholder="（空）" clearable     style=""></el-input>
    ...
    <div class="el_botton">
      ...
      <a href="#" @click.prevent="save">
        <el-button type="primary">保存课本信息</el-button>
      </a>
    </div>
    <!-- 预览区 -->
