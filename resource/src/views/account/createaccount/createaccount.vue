  ...
  <div class="g-form">
    <div class="col2 f-clearfix">
      <div class="control">
        ...
        <div class="txts">
          <el-select class="select select-newrole" v-model="roleId" placeholder="请选择新增账号角色"  @change="clearErrorTips">
            <el-option
          ...
          <a href="createrole.html" class="btn btn-green btn-m g-ml15">新增</a>
    ...
    <div class="col2 f-clearfix">
      <div class="control">
        ...
        <div class="txts">
          <input type="text" maxlength="10" @focus="clearErrorTips" class="ipt" placeholder="请输入工号" v-model.trim="jobNumber" />
          <span class="imptat">*</span>
        </div>
      </div>
      <div class="control">
